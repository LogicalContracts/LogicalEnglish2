...
[`sCASP_plan.md`](../../project/plans/sCASP_plan.md); this is the "what it does and how to use it"
...
(`docs/dev/migration.md`, "Exporting: the check before the text"). **All
...
backwards (lpsPlus/docs/migration/roadmap.md §5.7, Phase 2c):
