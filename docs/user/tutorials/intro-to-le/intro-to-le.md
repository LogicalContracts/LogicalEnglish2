...
*Kind: tutorial · Audience: users · Status: current (2026-07; screenshots of July)*
...
- Language reference: [`docs/user/reference/language.md`](https://github.com/LogicalContracts/LogicalEnglish2/blob/main/docs/user/reference/language.md)
- Editor manual: [`docs/user/guide/editor.md`](https://github.com/LogicalContracts/LogicalEnglish2/blob/main/docs/user/guide/editor.md)
...
(See `; unknown` in the [language reference](https://github.com/LogicalContracts/LogicalEnglish2/blob/main/docs/user/reference/language.md) for the full story.)
...
[`docs/user/reference/scasp.md`](https://github.com/LogicalContracts/LogicalEnglish2/blob/main/docs/user/reference/scasp.md).
...
- Skim the [language reference](https://github.com/LogicalContracts/LogicalEnglish2/blob/main/docs/user/reference/language.md)
...
- Read the [editor manual](https://github.com/LogicalContracts/LogicalEnglish2/blob/main/docs/user/guide/editor.md)
