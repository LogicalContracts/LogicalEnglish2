...
*Kind: reference · Status: superseded → see docs/user/reference/language.md*
...
> [`le_summary.md`](../../user/reference/language.md), which is the reference the agent guidelines
> point at.
