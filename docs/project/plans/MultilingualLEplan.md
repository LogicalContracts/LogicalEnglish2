...
*Kind: plan · Status: implemented → see i18n/README.md*
...
1. **LE Assistant** (light/deep): `le_assistant_light.pl` assembles the system
   ...
   `docs/user/reference/language.md` (syntax reference, English), and hardcoded curated
...
3. **LE Contract Assistant** (new, `le_contract_assistant.pl`): a multi-step
   contract-text→LE pipeline that reads `docs/user/reference/language.md` as its syntax
...
- Per-language prompt assets, shared by all three pipelines:
  `AGENTS_LE_template.<lang>.md` and a translated `docs/user/reference/language.<lang>.md`
...
3. Translate `docs/user/reference/language.md` and the curated examples; re-run the test suite
...
| **LE Contract Assistant** (`le_contract_assistant.pl`) | 3rd LLM pipeline; reads `docs/user/reference/language.md` | §1.6, §3.6 |
...
- **Phase 4**: `docs/user/reference/language.pt.md` + `AGENTS_LE_template.pt.md`;
...
remains open); `docs/user/reference/language.<lang>.md` exists only for pt (es/fr/it fall
