...
[${t("Open the view")}](#open-view)`);
    ...
    assistantInput.value = t("Refine the view section at the end of the program: group its facts under short titles, head the result by the value that matters, and add questions or a draft where they help. Use only the view sentences of docs/le_summary.md \xA717.10.");
  });
