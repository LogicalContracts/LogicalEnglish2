...
test.describe('Source viewer', () => {
    ...
    test('View Original Text in the context menu of a cited fact', async ({ page }) => {
        test.setTimeout(120000);
        await page.goto('index.html?example=regulatory/customs/apparel_cbp');
    ...
    test('the source viewer is legible in the light theme', async ({ page }) => {
        ...
        await page.goto('index.html?example=regulatory/customs/apparel_cbp&scenario=ny_n362700');
