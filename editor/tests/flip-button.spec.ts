...
test.describe('Flip button', () => {
    test('flips the selected answer', async ({ page }) => {
        ...
        await page.goto('index.html?example=regulatory/customs/plastics_cbp&scenario=ny_n363253&query=heading');
    ...
    test('on a flip query, offers its goal', async ({ page }) => {
        test.setTimeout(120000);
        await page.goto('index.html?example=regulatory/customs/plastics_cbp&scenario=ny_n363253&query=household');
    ...
    test('keeps a number-like value a string', async ({ page }) => {
        test.setTimeout(120000);
        await page.goto('index.html?example=regulatory/customs/cbp_39&scenario=ny_n345907&query=subheading');
