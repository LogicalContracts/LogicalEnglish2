...
export const uiCatalog: Record<string, Record<string, string>> = {
  ...
  "pt": {
    ...
    "Write it in English…": "Escreva em Português…",
    "You have unsaved changes. Create new file anyway?": "Tem alterações não guardadas. Criar um ficheiro novo mesmo assim?",
    "You have unsaved changes. Load from URL anyway?": "Tem alterações não guardadas. Carregar do URL mesmo assim?",
    "You have unsaved changes. Open another file anyway?": "Tem alterações não guardadas. Abrir outro ficheiro mesmo assim?",
    "You have unsaved changes. Open from server anyway?": "Tem alterações não guardadas. Abrir do servidor mesmo assim?",
