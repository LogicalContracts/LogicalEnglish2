...
| the_loan_is_accelerated_on/1 | predicate | encoded | a template (the #pred wording, else a naive one) | the loan is accelerated on *a date* |  |
...
| ?- defaults_on(_80626,_80628) | query | encoded | a ?- query -> a query, asked in every scenario | the queries |  |
