# Migration ledger: bolt3_received_htlc

Source: A Lightning received HTLC (BOLT #3) — https://bitcoin.sipa.be/miniscript/
...
| and(pk(key_remote),or(and(pk(key_local),hash160(H)),older(1008))) | spending path | encoded | a branch of the top-level or -> a rule concluding the coin can be spent | remote_with_preimage_or_timeout |  |
...
|---|---|---|---|
| remote_with_preimage_or_timeout_1 | spendable | pass |  |
| remote_with_preimage_or_timeout_1_without_1 | spendable | pass |  |
| remote_with_preimage_or_timeout_1_without_2 | spendable | pass |  |
| remote_with_preimage_or_timeout_2 | spendable | pass |  |
| remote_with_preimage_or_timeout_2_without_1 | spendable | pass |  |
| remote_with_preimage_or_timeout_2_without_2 | spendable | pass |  |
| remote_with_preimage_or_timeout_2_without_3 | spendable | pass |  |
...
| chain_remote_with_preimage_or_timeout_1 | spendable | pass |  |
| chain_remote_with_preimage_or_timeout_1_without_1 | spendable | pass |  |
| chain_remote_with_preimage_or_timeout_2 | spendable | pass |  |
| chain_remote_with_preimage_or_timeout_2_without_1 | spendable | pass |  |
| chain_remote_with_preimage_or_timeout_2_without_2 | spendable | pass |  |
| chain_remote_with_preimage_or_timeout_2_without_3 | spendable | pass |  |
