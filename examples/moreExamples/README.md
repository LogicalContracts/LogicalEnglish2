...
- [`language/`](language/README.md) — one program per language feature;
- [`domains/`](domains/README.md) — larger programs about a subject;
- [`collections/`](collections/README.md) — examples of a book or a talk;
- `insureLE2/` — the proprietary examples, when linked and allowed.
