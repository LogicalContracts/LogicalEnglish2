# Logical Thinking in the Age of AI: details

The programs, slide by slide, the links the slides use, excerpts that fit on
a slide, and where the content comes from.
