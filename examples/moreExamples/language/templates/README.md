...
- `is_a_class_of.le` — the `is a` of types and classes.
- `longsentence.le` — a template with many slots.
- `subset.le` — a universal ("for all cases in which …") over sets and lists.
