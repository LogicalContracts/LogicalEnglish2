...
le_system_template(dict([le_ge, V1, V2], [V1-any, V2-any], [V1, is, greater, than, or, equal, to, V2])).
le_system_template(dict([le_le, V1, V2], [V1-any, V2-any], [V1, is, less, than, or, equal, to, V2])).
le_system_template(dict([le_gt, V1, V2], [V1-any, V2-any], [V1, is, greater, than, V2])).
le_system_template(dict([le_lt, V1, V2], [V1-any, V2-any], [V1, is, less, than, V2])).
le_system_template(dict([le_ge, V1, V2], [V1-any, V2-any], [V1, is, after, or, equal, to, V2])).
le_system_template(dict([le_le, V1, V2], [V1-any, V2-any], [V1, is, before, or, equal, to, V2])).
le_system_template(dict([le_gt, V1, V2], [V1-any, V2-any], [V1, is, after, V2])).
le_system_template(dict([le_lt, V1, V2], [V1-any, V2-any], [V1, is, before, V2])).
